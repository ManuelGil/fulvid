export default {
  ...
  settings: {
    ...
    extensionUninstallMessage:
      '¿Quitar "{name}" ({id}) de este equipo?\n\nSe eliminarán sus archivos y el consentimiento de carga de este paquete. Las demás extensiones no se ven afectadas.',
    ...
    extensionLocation: "Ubicación instalada",
    extensionReason: "Detalle de carga",
    extensionOpenFolder: "Mostrar carpeta",
    extensionOpenFolderFailed: "No se pudo abrir esa carpeta de extensión.",
    extensionReviewBlocked: "Revisar / Cargar de todos modos",
    extensionAllowTitle: "¿Cargar extensión bloqueada?",
    extensionAllowMessage:
      '"{name}" ({id}) no se cargó.\n\nMotivo: {reason}\n\nCargarla ejecuta código no confiable en el entorno aislado de Fulvid. Continúa solo si confías en este paquete.',
    extensionAllowConfirm: "Cargar de todos modos",
    extensionAllowSucceeded: 'Se cargó la extensión "{id}".',
    extensionAllowStillFailed: 'La extensión "{id}" sigue fallando: {reason}',
    extensionAllowFailed: "No se pudo completar esa carga de extensión.",
    extensionUnknownReason: "Fallo de validación desconocido",
