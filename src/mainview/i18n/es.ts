export default {
  ...
  settings: {
    ...
    extensions: "Extensiones",
    extensionsHint:
      "Paquetes instalados y su estado de carga. Las acciones aparecen en los menús de Fulvid; los paquetes siempre activos decoran el documento activo tras la precarga.",
    ...
    extensionOpenFolder: "Abrir carpeta de la extensión",
    extensionOpenFolderFailed: "No se pudo abrir esa carpeta de extensión.",
    extensionReviewBlocked: "Revisar extensión bloqueada",
    ...
    extensionStateAllowed: "Permitida explícitamente",
