export default {
  ...
  settings: {
    ...
    extensionUninstallMessage:
      'Remove "{name}" ({id}) from this computer?\n\nIts files and load consent for this pack will be deleted. Other extensions are not affected.',
    ...
    extensionLocation: "Installed location",
    extensionReason: "Load details",
    extensionOpenFolder: "Reveal Folder",
    extensionOpenFolderFailed: "Couldn't open that extension folder.",
    extensionReviewBlocked: "Review / Load anyway",
    extensionAllowTitle: "Load blocked extension?",
    extensionAllowMessage:
      '"{name}" ({id}) was not loaded.\n\nReason: {reason}\n\nLoading it runs untrusted code with Fulvid\'s extension sandbox. Only continue if you trust this pack.',
    extensionAllowConfirm: "Load anyway",
    extensionAllowSucceeded: 'Loaded extension "{id}".',
    extensionAllowStillFailed: 'Extension "{id}" still failed: {reason}',
    extensionAllowFailed: "Couldn't complete that extension load.",
    extensionUnknownReason: "Unknown validation failure",
