export default {
  ...
  settings: {
    ...
    extensions: "Extensions",
    extensionsHint:
      "Installed packs and their security load state. Extension actions appear in Fulvid menus; always-on packs decorate the active document after preload.",
    ...
    extensionOpenFolder: "Open Extension Folder",
    extensionOpenFolderFailed: "Couldn't open that extension folder.",
    extensionReviewBlocked: "Review blocked extension",
    ...
    extensionStateAllowed: "Explicitly allowed",
