/**
 * Declarative AppIcon name resolution.
 *
 * Icon identifiers are data. Unknown strings never become HTML, SVG, or code.
 */
...
/**
 * Resolve a declared icon name to a known AppIcon id.
 * Unknown strings return null — never HTML, SVG, or code.
 */
