...
Keyboard shortcuts cover the usual desktop habits: new file, save, find, follow a link, rename a heading (`F2`), find heading references (`Shift+F12`), and a Focus mode that quiets the chrome while you type. There is no Command Palette and no Quick Open. Monaco is the only editor.
