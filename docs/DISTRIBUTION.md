...
A public tag can be attached by hand from workflow artifacts or a local Linux set, using the matching file under [releases/](./releases/) as the body (`v0.2.0.md` for this version). Do not flip the gate just to finish a documentation pass.
