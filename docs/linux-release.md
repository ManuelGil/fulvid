...
Copy the files you need onto a GitHub Release yourself. Use the matching file under [releases/](./releases/) as the body (`v1.0.0.md` for the current release notes; use `vX.Y.Z.md` for the version you are shipping).
