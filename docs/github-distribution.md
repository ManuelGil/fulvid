...
- The action sets `generate_release_notes: true` (GitHub's commit list). For `v0.1.0`, use [releases/v0.1.0.md](./releases/v0.1.0.md) when attaching the first Release by hand.
